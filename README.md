...
- **Song Library** — Create and manage songs with BPM, time signature, key, and free-form notes/charts
...
- **Performance Mode** — Full-screen view optimized for stage use with large text, prev/next song navigation within setlists, and integrated metronome
...
- **Dark Mode** — Dark theme by default for stage visibility, with light mode toggle
...
- **Data:** Firestore for authenticated users (`users/{userId}/songs/{songId}`), localStorage for guests
