    ...
    if (!resolvedUrl) {
      return (
        <div className="flex flex-col items-center justify-center h-full text-[var(--muted)]">
          ...
          <p className="text-sm">{!isOnline ? 'Not available offline' : isCloudLinked(attachment) ? 'Open a Drive file to reconnect' : 'Image not available'}</p>
        </div>
      );
    }
    return (
    ...
    if (!resolvedUrl) {
      return (
        <div className="flex flex-col items-center justify-center h-full text-[var(--muted)]">
          ...
          <p className="text-sm">{!isOnline ? 'Not available offline' : isCloudLinked(attachment) ? 'Open a Drive file to reconnect' : 'PDF not available'}</p>
        </div>
      );
    }
    return (
